...
//           {educationData.map((item, index) => (
//             <div key={index} className="education-card-mobile">
//               <div className="card-header">
//                 <span className={`type-badge ${item.type === 'education' ? 'education' : 'experience'}`}>
...
function MobileCard({ item }) {
  ...
  return (
    <div className="education-card-mobile">
      <div className="card-accent-bar mobile-accent"></div>
